...
# ⚗ 线性代数
- [0️⃣ 1️⃣](#-P1-二阶三阶行列式) ┃ [0️⃣2️⃣](#-P2-n阶行列式) | [0️⃣3️⃣](#-P3-行列式的性质) | [0️⃣4️⃣](#-P4-行列式按行展开) | [0️⃣5️⃣](#-P5-行列式的计算（一）) | [0️⃣6️⃣](#-P6-行列式的计算（二）) | [0️⃣7️⃣](#-P7-克莱姆法则) | [0️⃣8️⃣](#-P8-矩阵概念) | [0️⃣9️⃣](#-P9-矩阵运算（一）) | [1️⃣0️⃣](#-P10-矩阵运算（二）)
## ☄ P1 二阶三阶行列式
### ⌚ 02:48 二阶行列式划线计算
- 行列式一定是方的
### ⌚ 15:00 三阶行列式划线计算
