...
# 💡 前言
- 我发现吧，线代没记笔记真不行。
- 浩浩学习，天天向上。数学网课推荐[🐀宋浩老师](https://space.bilibili.com/66607740)的**免费**视频，冲冲冲~~~
- 如有遗漏或错误欢迎推PR或发Issue~
...
- [3️⃣1️⃣](#-线性代数) | [3️⃣2️⃣](#-P32-矩阵的特征值与特征向量一) | [3️⃣3️⃣](#-P33-矩阵的特征值与特征向量二) | [3️⃣4️⃣](#-P34-特征值与特征向量的性质) | [3️⃣5️⃣](#-P35-相似矩阵和矩阵可对角化的条件) | [3️⃣6️⃣](#-P36-实对称矩阵的对角化一) | [3️⃣7️⃣](#-P37-实对称矩阵的对角化二) | [3️⃣8️⃣](#-P38-实对称矩阵的对角化三) | [3️⃣9️⃣](#-P39-二次型定义) | [4️⃣0️⃣](#-P40-二次型化标准型配方法) | [4️⃣1️⃣](#-P41-二次型化标准型初等变换法和正交替换法)
## ☄ P1 二阶三阶行列式
### ⌚ 02:48 二阶行列式划线计算
- 行列式一定是方的
### ⌚ 15:00 三阶行列式划线计算
